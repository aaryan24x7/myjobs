node{
stage('parameters'){
properties([buildDiscarder(logRotator(artifactDaysToKeepStr: '1', artifactNumToKeepStr: '5', daysToKeepStr: '5', numToKeepStr: '5')), parameters([choice(choices: ['ls-lart'], description: '', name: 'GERRIT_BRANCH')]), pipelineTriggers([])])
}
stage('java version'){
java('1.7')
}
